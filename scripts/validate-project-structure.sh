...
required_files=(
  ...
  "src/DeskTown.Domain/Events/EventSystem.cs"
  "src/DeskTown.Domain/Events/EventSystemCheckpoint.cs"
  "src/DeskTown.Domain/Simulation/MinaStateMachine.cs"
  "src/DeskTown.Domain/Simulation/TownSimulation.cs"
  "src/DeskTown.Domain/Simulation/TownSimulationSnapshot.cs"
  ...
  "src/DeskTown.Application/Lifecycle/ApplicationLifecycleCoordinator.cs"
  "src/DeskTown.Application/Lifecycle/CheckpointScheduler.cs"
  "src/DeskTown.Application/Persistence/EventSaveMapper.cs"
  "src/DeskTown.Persistence/JsonGameStateStore.cs"
  ...
  "src/DeskTown.Application/Display/DisplayModeController.cs"
  ...
  "tests/DeskTown.Domain.Tests/TownSimulationTests.cs"
  "tests/DeskTown.Domain.Tests/EventSystemTests.cs"
  ...
  "tests/DeskTown.Application.Tests/ApplicationLifecycleCoordinatorTests.cs"
  "tests/DeskTown.Platform.Windows.Tests/Lifecycle/WindowsSingleInstanceGateTests.cs"
  "tests/DeskTown.Application.Tests/JsonGameStateStoreTests.cs"
